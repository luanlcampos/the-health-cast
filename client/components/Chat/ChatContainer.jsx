...
export default function ChatContainer() {
    ...
    if(userData!=null){
        return (
            <>
                <input className='chat-input hidden' id='offchat-menu' type='checkbox'/>
                ...
                <div className='sticky-chat'>
                    <div className="w-full h-2/3 flex border-t-8 green-border">
                            <Sidebar 
                                key = {userData.email}
