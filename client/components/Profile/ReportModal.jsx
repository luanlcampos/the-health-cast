...
export default function ReportModal({/*props*/reportedUserData, reportedUserId, reportingThread, reportingLive}) {
  ...
  const handleSubmit = async (event) => {
    try {
      ...
      } else if (reportingLive && reportedUserData.liveSessId){ //must be either a live sess
